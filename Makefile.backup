#
# OMNeT++/OMNEST Makefile for $(LIB_PREFIX)uav_mesh_baseline
#
# This file was generated with the command:
#  opp_makemake --make-so -f --deep -o uav_mesh_baseline -O out -KINET_4_7_0_PROJ=../inet-4.7.0 -DINET_IMPORT -I$(INET_4_7_0_PROJ)/src -L$(INET_4_7_0_PROJ)/src -lINET$(D)
#

# Name of target to be created (-o option)
TARGET_DIR = .
TARGET_NAME = $(LIB_PREFIX)uav_mesh_baseline$(D)
TARGET = $(TARGET_NAME)$(SHARED_LIB_SUFFIX)
TARGET_FILES = $(TARGET_DIR)/$(TARGET)

# C++ include paths (with -I)
INCLUDE_PATH = -I$(INET_4_7_0_PROJ)/src
...
OBJS = $O/src/GatewayAwareAodv.o $O/src/UavStatsCollector.o
...
LIBS += -Wl,-rpath,$(abspath $(INET_4_7_0_PROJ)/src)
endif
...
ifeq ($(PLATFORM),win32)
  ...
  OUT_TARGET_EXTRA_FILES = $O/$(TARGET_IMPLIB)
  ifeq ($(TOOLCHAIN_NAME),clang-msabi)
    ...
    OUT_TARGET_EXTRA_FILES+= $O/$(TARGET_IMPDEF)
  endif
endif
...
$O/$(TARGET) $(OUT_TARGET_EXTRA_FILES) &: $(OBJS)  $(wildcard $(EXTRA_OBJS)) Makefile $(CONFIGFILE)
	@$(MKPATH) $O
